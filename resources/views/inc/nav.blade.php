...
$(document).ready(function() {
    ...
    $(".toggle-sublist").click(function() {
      ...
      <!-- <li class="list-none"><a href="/createuser" class="list-group-item list-group-item-action bg-light text-adjust {{ (request()->is('certificate*')) ? 'active-page active' : '' }}"><i class="fa fa-certificate fa-lg icon-adjust"></i> Create User</a> </li> -->
