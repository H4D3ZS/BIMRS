...
<ul class="nav nav-tabs" style="margin-left: 20px;">
    ...
    <li class="nav-item"><a class="nav-link" href="/barangay/schedule">Summon</a></li>
    <li class="nav-item"><a class="nav-link" href="/barangay/blotter/{{ session("resident.id") }}">Blotter</a></li>
