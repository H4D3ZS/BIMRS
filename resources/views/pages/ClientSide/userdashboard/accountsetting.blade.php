            ...
            <div class="rounded shadow-lg border border-secondary p-4" style="font-size: 20px">
                ...
                <div class="form-row p-3">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="text" id="resident_accountsetting_birthplace" name="resident_accountsetting_birthplace"  class="form-control " placeholder="Ex: Gensan">
                    </div>
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <textarea id="resident_accountsetting_address_1" name="resident_accountsetting_address_1" placeholder="Ex: Brgy Baluntay, Sarangani"  class="form-control " rows="2" style="resize: none;"></textarea>
                    </div>
