         ...
         <div class="jumbotron" style="margin-bottom: 175px;padding-top: 0px;background-color: white !important;">
            <div class="album py-5 bg-white">
               <div class="text-center">
                  <!-- <h1 >Summon Letters</h1> -->

                  <!-- <iframe  width="1024" height="1024"></iframe> -->
                  <iframe src="{{url('http://localhost:8000/barangay/news')}}" width="1024" height="1024>Your browser isn't compatible</iframe>
                  <br>
               </div>
               <div class="container">
                  <div class="row">
